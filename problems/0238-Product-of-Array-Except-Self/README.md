...
| 💾 Memory  | 72 MB (Beats 40%) | **72 MB (Beats 40%)** |

## 💡 Solutions (4 total)

| # | File | Language | Date |
|:-:|------|:--------:|:----:|
| 1 | [sol1.java](./sol1.java) | `Java` | 2026-06-26 |
| 2 | [sol2.java](./sol2.java) | `Java` | 2026-06-26 |
| 3 | [sol3.java](./sol3.java) | `Java` | 2026-06-26 |
| 4 | [sol4.java](./sol4.java) | `Java` | 2026-06-26 ← **latest** |
